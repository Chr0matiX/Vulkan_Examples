...
VkResult VulkanExampleBase::createInstance()
{
	...
	uint32_t extCount = 0;
	// vkEnumerateInstanceExtensionProperties：可以获取当前机器里所有[驱动]支持的示例扩展[并集]
	// 后续可通过 vkEnumerateDeviceExtensionProperties 来获取目标设备[支持]的示例扩展
	...
	// VK_LAYER_KHRONOS_validation 是整合后的通用验证层，强泛用性
